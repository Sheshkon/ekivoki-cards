    ...
    <main class="main-content">
      ...
      <div v-else-if="store.phase === 'idle'" class="start-screen">
        ...
        <div class="button-group">
          <button class="btn-primary" @click="store.generateCard(false)">Обычная (1-5)</button>
          <button class="btn-secondary-purple" @click="store.generateCard(true)">Особая (6)</button>
        </div>
      </div>
...
.btn-primary:active, .btn-secondary-purple:active {
